...
public class MultiSourceExAop implements Ordered {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        System.out.println("ds methodSignature AOP = " + methodSignature.getName());
        Object target = point.getTarget();
        System.out.println("ds target = " + target.toString());
        Method currentMethod = target.getClass().getMethod(methodSignature.getName(), methodSignature.getParameterTypes());
        System.out.println("ds ll currentMethod = " + currentMethod.getName());
    ...
    @Override
    public int getOrder() {
        System.out.println("在ds中， AOP切换时在处理优先级时的操作。。。。 ");
        return 1;
    }
